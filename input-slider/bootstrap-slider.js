		...
		function createNewSlider(element, options) {
			...
			**************************************************/
			...
			if (this.sliderElem) {
				...
				sliderIconLeft = document.createElement("i");
				sliderIconLeft.className = "fa fa-angle-left";

				sliderValue = document.createElement("span");
				sliderValue.className = "slider_value";
				sliderValue.attributes = "left:0px";

				sliderIconRight = document.createElement("i");
				sliderIconRight.className = "fa fa-angle-right";
				sliderIconRight.attributes = "right:0px";

				sliderTrack.appendChild(sliderTrackLeft);
				sliderTrack.appendChild(sliderTrackSelection);
				sliderTrack.appendChild(sliderTrackRight);
				sliderMinHandle.appendChild(sliderIconLeft);
				sliderMinHandle.appendChild(sliderValue);
				sliderMinHandle.appendChild(sliderIconRight);
